...
<body class="telalog">   
    ...
    <h3>Cadastro de Aluno</h3>
        <form action="ValidCadastroAluno.php" class="formtest" method="POST">
            ...
            <div>
                ...
                <input type="date" class="form-control" name="datanasc" id="formGroupExampleInput" >
            </div>
                
            <div> 
                <label for="formGroupExampleInput" class="form-label">Endereço: </label>
                <input type="text" class="form-control" name ="endaluno" id="formGroupExampleInput" placeholder="Dgite o endereço"  maxlength="50">
            </div>

            <div>
                <label for="formGroupExampleInput" class="form-label">RG: </label>
                <input type="text" class="form-control" name="Rgaluno" id="formGroupExampleInput" placeholder="Digite o RG"  maxlength="12">
            </div>
            <div>
                <label for="formGroupExampleInput" class="form-label">CPF: </label>
                <input type="text" class="form-control" name="CpfAluno" onkeypress="mascara(this, 'cpf')" placeholder="Digite o CPF" maxlength="14">
            </div>
            <div>
                <label for="formGroupExampleInput" class="form-label">SEXO: </label>
                <input type="text" class="form-control" name="SexoAluno" id="formGroupExampleInput" placeholder="Digite o SEXO"  maxlength="10">
            </div>    
            <div>
                <label for="formGroupExampleInput" class="form-label">Codigo da Turma: </label>
                <input type="text" class="form-control" name="CodTuma" id="formGroupExampleInput" placeholder="Digite a turma" maxlength="3">
            </div> 
            <div>
            </div>
            <div class="Container-botao">
                <input type="submit" class="btn btn-primary" value="Cadastrar" >
                <input type="button" onclick= "location.href = 'listaAluno.php'" class="btn btn-primary" value="Listar">
            </div> 
        </div>
        </form>
        </div>
